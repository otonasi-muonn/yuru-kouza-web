...
export function MarkdownEdit() {
  return (
    <div>
      ...
      <ul>
        <li>
          <strong><code>README.md</code> が見当たらない</strong> → リポジトリ作成時に「Add a README file」を付け忘れた可能性があります。
          VSCode のエクスプローラ上部にある「新しいファイル」から <code>README.md</code> を作り、このページのテンプレを貼り付ければ先に進めます。
        </li>
        <li>
